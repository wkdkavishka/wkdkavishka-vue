    ...
    >
      ...
      <div class="px-6 mt-2">
        ...
        <div class="w-full flex justify-center pt-5 pb-5">
          ...
          <a :href="linkedin" class="mx-5" aria-label="LinkedIn" role="img">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
...
const props = defineProps({
  ...
  git: { type: String, default: "git link" },
  x: { type: String, default: "x link" },
  linkedin: { type: String, default: "linkedin link" },
