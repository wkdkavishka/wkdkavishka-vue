      ...
      <nav class="flex items-center justify-between flex-wrap py-3 px-4">
        ...
        <div class="flex-col items-center text-white mr-6">
          ...
          <div id="download" class="flex justify-center">
            <a
              href="#"
              class="text-center block sm:hidden text-sm px-4 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-teal-500 hover:bg-white md:block md:flex-auto my-1"
              >Download</a
            >
          </div>
        </div>
        ...
        <div
          id="menu"
          name="menu"
          class="flex-auto flex-wrap md:flex md:items-center md:w-auto sm:w-6/12 px-4"
        >
          <div class="text-sm sm:block md:flex justify-between">
            <a
